@php
    $hideChevron = ['settings.profile', 'settings.password', 'settings.appearance'];
    $shouldShowChevron = !in_array(request()->route()->getName(), $hideChevron);
@endphp
                        ...
                        <flux:dropdown position="bottom" align="end">
                                @if ($shouldShowChevron)
                                    ...
                                    <flux:menu class="w-[220px]">
                                            ...
                                            <flux:menu.radio.group>
                                                <flux:menu.item :href="route('profile')" icon="user-circle" wire:navigate>{{ __('Profile') }}</flux:menu.item>
                                            </flux:menu.radio.group>
