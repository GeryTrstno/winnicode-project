<div>
    ...
    @if ($hasMorePages)
        <div class="flex flex-col justify-center items-center mt-4">
            <flux:button wire:click="loadMore" class="mt-2 text-white! rounded-lg focus:ring-1 focus:outline-none focus:ring-zinc-300 bg-zinc-900! text-white! hover:bg-zinc-700! dark:bg-zinc-100! dark:text-black! dark:hover:bg-zinc-300! dark:focus:ring-zinc-500!" wire:loading.attr="disabled" wire:target="loadMore">
                Load More
            </flux:button>
        </div>
    @endif
